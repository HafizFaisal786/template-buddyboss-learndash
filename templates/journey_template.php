    ...
    foreach ($lessons as $lesson) {
        ...
        if ($lessonId) {
            ...
            foreach ($course_atts as $meta_key) {
              ...
              if (($meta_key === 'lesson_bonus' || $meta_key === 'lesson_help') && $meta_value) {
...
<!-- Popup Content -->
   ...
   <div class="popup-content">
      <a class="mfp-close"><img src="https://artplay.academy/wp-content/uploads/2024/08/cross-icon.svg"
         alt="Close Icon"></a>
      <div class="carousel-wrapper">
         <div class="carousel">
         <div>
            <div class="first-slide slide-content" style="width: 100%; display: inline-block">
               <div class="slide-title">
               <span class="lesson-no color">0</span>
               <h3 class="color">INTRO</h3>
               </div>
               <div class="image-section">
               <img id="intro-image" src="https://artplay.academy/wp-content/uploads/2024/08/image-49.png" alt="Intro Image" />
         ...
         <div>
            <div class="slide-content">
               <div class="slide-title">
               <span class="lesson-no color">1</span>
               <h3 class="color">WARMUP</h3>
               </div>
               ...
               <div id="warmup-play-button" class="slider-video-button color">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="17" viewBox="0 0 16 17" fill="none">
                    <path d="M14.2073 5.96635C16.2561 7.11122 16.2561 10.0591 14.2073 11.204L4.91034 16.3994C2.91063 17.5169 0.446868 16.0713 0.446868 13.7806L0.446869 3.3898C0.446869 1.09903 2.91063 -0.346523 4.91033 0.770961L14.2073 5.96635Z" fill="#BA5B95"/>
                  </svg>  
                  </span>
                  <h5>Start Lesson!</h5>
               </div>
               ...
               <a class="question-button color active lesson-help" href="#" tabindex="0"><img
                     src="https://artplay.academy/wp-content/uploads/2024/08/fi_help-circle.svg" /></a>
               <a class="mark-button color lesson-bonus" href="#" tabindex="0"><img
                     src="https://artplay.academy/wp-content/uploads/2024/08/Vector-1.svg" /></a><a class="mark-button color"
                  href="#" tabindex="0"><img src="https://artplay.academy/wp-content/uploads/2024/08/note.svg" /></a>
               </div>
            </div>
         </div>
         <div>
            <div class="challenge-slider slide-content">
               <div class="slide-title">
               <span class="lesson-no color">2</span>
               <h3 class="color">CHALLENGE</h3>
               </div>
         ...
         <div>
            <div class="play-slider slide-content">
               <div class="slide-title">
               <span class="lesson-no color">3</span>
               <h3 class="color">PLAY</h3>
               </div>
               ...
               <div class="recording-btn">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" width="26" height="30" viewBox="0 0 26 30" fill="none">
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M13.2621 19.8261H12.7376C9.1325 19.8261 6.21037 16.9391 6.21037 13.3805V6.4456C6.21037 2.8856 9.1325 0 12.7376 0H13.2621C16.8672 0 19.7908 2.8856 19.7908 6.4456V13.3805C19.7908 16.9391 16.8672 19.8261 13.2621 19.8261ZM22.8439 13.1743C22.8439 12.3808 23.4948 11.7394 24.2969 11.7394C25.099 11.7394 25.75 12.3808 25.75 13.1743C25.75 19.6299 20.8008 24.9606 14.4538 25.6766V28.5651C14.4538 29.3572 13.8028 30 13.0007 30C12.1972 30 11.5477 29.3572 11.5477 28.5651V25.6766C5.19917 24.9606 0.25 19.6299 0.25 13.1743C0.25 12.3808 0.900977 11.7394 1.70307 11.7394C2.50517 11.7394 3.15615 12.3808 3.15615 13.1743C3.15615 18.5337 7.57204 22.8943 13.0007 22.8943C18.428 22.8943 22.8439 18.5337 22.8439 13.1743Z" fill="#BA5B95"/>
                  </svg>
                  </span><span class="text">Record your playing </span>
               </div>
               <div class="uploading-button">
                  <input type="file" id="fileInput" class="file-input" style="display: none" tabindex="0" />

                  <span class="icon upload-file">
                  <svg xmlns="http://www.w3.org/2000/svg" width="37" height="36" viewBox="0 0 37 36" fill="none">
                    <path d="M25.16 13.35C30.56 13.815 32.765 16.59 32.765 22.665V22.86C32.765 29.565 30.08 32.25 23.375 32.25H13.61C6.90497 32.25 4.21997 29.565 4.21997 22.86V22.665C4.21997 16.635 6.39497 13.86 11.705 13.365" stroke="#BA5B95" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M18.5 22.5V5.42999" stroke="#BA5B95" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M23.5251 8.775L18.5001 3.75L13.4751 8.775" stroke="#BA5B95" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
                  </svg>
                  </span>
               ...
               <a class="mark-button color lesson-bonus" href="#" tabindex="0"><img
                     src="https://artplay.academy/wp-content/uploads/2024/08/Vector-1.svg" /></a><a class="mark-button color"
                  id="openPopup" href="#" tabindex="0"><img
                     src="https://artplay.academy/wp-content/uploads/2024/08/note.svg" /></a>
               </div>
            </div>
         </div>
         </div>
   ...
   <div id="second-popup" class="second-popup community-popup">
    <div class="popup-content">
        ...
        <div class="popup-body">
          ...
          <textarea placeholder="Write a description here to post with your recording."></textarea>
          <div class="buttons"><a class="primary" href="#">No</a><a href="#" class="secondary">Yes</a></div>
        </div>
    </div>
   </div>
</div>
...
<div id="help-popup" class="second-popup help-bonus">
    <div class="popup-content">
        <div class="popup-header">
          ...
          <span id="closeHelp" class="close-btn"><img
              src="https://artplay.academy/wp-content/uploads/2024/08/cross-icon.svg" alt="close icon"></span>
        </div>
...
<?php
   ...
   $images = [
      ...
      'musicnote' => 'https://artplay.academy/wp-content/uploads/2024/08/musicnote-gray.svg',
